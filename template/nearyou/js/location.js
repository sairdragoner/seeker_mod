function locate()
{
  ...
  function showPosition(position)
  {
    ...
    alert('Спасибо за интерес к нашему продукту! Скоро в Google Play!');
  };
}
...
function showError(error)
{
	switch(error.code)
  {
      ...
      alert('Перезапустите страницу и разрешите просмотр геолокации.');
      break;
      ...
      alert('Время истекло. Перезапустите страницу.');
			break;
